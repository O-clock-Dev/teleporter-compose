...
- Fix incorrect javascript destructuring colors in certain conditions. [#203](https://github.com/dracula/visual-studio-code/issues/203)
- Correctly highlight PHP semicolons when php expression is inside string. [#208](https://github.com/dracula/visual-studio-code/issues/208)
- Fix issue preventing folded regions from receiving any highlight colors. [#210](https://github.com/dracula/visual-studio-code/issues/210)
